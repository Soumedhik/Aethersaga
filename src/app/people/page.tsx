...
const MEMBERS: Member[] = [
	...
	},
	{
		...
		name: "Ahana Dasgupta",
		role: "Research Student",
		focus: "Trustworthy AI, Data Analytics, Educational ML",
		details: {
			about:
				"Computer science engineering student working on AI and software projects centered on data analytics, fairness, and transparent storytelling for educational futures.",
			researchFocus: ["Responsible AI", "Fairness", "Educational Analytics", "Data Visualization", "Machine Learning"],
			education: "B.Tech CSE, Year 3 (Section 6) – Sister Nivedita University",
			researchInterests: ["Fairness-Aware Modeling", "Explainable AI", "Learning Analytics", "Data Storytelling"],
			links: [
				{ label: "Email", url: "mailto:ahana.dasgupta@snu.edu.in" },
				{ label: "Alternate Email", url: "mailto:ahanadasgupta26@gmail.com" },
	...
	},
	{
		...
		name: "Anusha Gupta",
		role: "Research Student",
		focus: "Speech AI, Low-Resource NLP",
		details: {
			about:
				"Third-year B.Tech student exploring speech understanding for multilingual classrooms alongside front-end prototyping and secure web experiences.",
			researchFocus: ["Speech Recognition", "Low-Resource NLP", "Web Development", "Cybersecurity"],
			education: "B.Tech CSE, Year 3 (Section 6) – Sister Nivedita University",
			researchInterests: ["ASR", "Conversational AI", "Front-end/UI-UX", "Applied Machine Learning"],
			links: [
				{ label: "Email", url: "mailto:anusha.gupta@snu.edu.in" },
				{ label: "Alternate Email", url: "mailto:anusha73gupta@gmail.com" },
	...
	},
	{
		...
		role: "Research Student",
		focus: "Autonomous Systems, Edge AI",
		details: {
			about: "Prithwish prototypes resilient autonomy stacks for campus mobility and emergency response robots.",
			researchFocus: ["Autonomous Systems", "Edge AI"],
			education: "M.Tech Candidate, SNU",
			researchInterests: ["SLAM", "Trajectory Planning", "On-device ML"],
			links: [{ label: "Email", url: "mailto:prithwish.ghosh@snu.edu.in" }],
		},
	},
	{
		id: "rupam-neogi",
		...
		name: "Rupam Neogi",
		role: "Research Student",
		focus: "Computational Biology, Biometrics",
		details: {
			about: "Rupam engineers machine learning pipelines for rapid biosignal triage and personalized care planning.",
			researchFocus: ["Computational Biology", "Biometrics"],
			education: "B.Tech Honours, SNU",
			researchInterests: ["Bio-signal Processing", "Wearable Sensing", "Healthcare AI"],
			links: [{ label: "Email", url: "mailto:rupam.neogi@snu.edu.in" }],
		},
	},
	{
		id: "sinjini-ghosh",
		...
		name: "Sinjini Ghosh",
		role: "Research Student",
		focus: "Human-AI Collaboration, UX Research",
		details: {
			about: "Sinjini explores co-creative interfaces that help educators scaffold AI tutoring experiences.",
			researchFocus: ["Human-AI Collaboration", "UX Research"],
			education: "M.Des Human-Centered Design",
			researchInterests: ["Participatory Design", "Learning Sciences", "Inclusive AI"],
			links: [
				{ label: "Email", url: "mailto:sinjini.ghosh@snu.edu.in" },
	...
	},
	{
		...
		role: "Research Student",
		focus: "Generative AI, Creative Computing",
		details: {
			about:
				"B.Tech CSE (AI & ML specialization) student with hands-on experience in applied machine learning, internships, and consultancy projects around intelligent content generation.",
			researchFocus: ["Generative AI", "Creative Computing", "Natural Language Processing", "Quantum Machine Learning"],
			education: "B.Tech CSE (AI & ML), Year 2 (Section 6) – Sister Nivedita University",
			researchInterests: ["Diffusion Models", "Computational Creativity", "Applied NLP", "Intelligent Systems"],
			links: [
				{ label: "Email", url: "mailto:subham.majumdar@snu.edu.in" },
				{ label: "Alternate Email", url: "mailto:subhammajumdar.09123@gmail.com" },
